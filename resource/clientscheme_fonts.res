Scheme
{
	...
	Fonts
	{
		...
		"G_FontHuge"
		{
			"1"
			{
				"name"			"Days" [$WINDOWS] // Primary font
				"name"			"Days" [!$WINDOWS] // Primary font
		...
		"G_FontHealth"
		{
			"1"
			{
				"name"			"Days" [$WINDOWS] // Health Font | Primary font
				"name"			"Days" [!$WINDOWS] // Health Font | Primary font
		...
		"G_FontAmmo"
		{
			"1"
			{
				"name"			"Days" [$WINDOWS] // Ammo Font | Primary font
				"name"			"Days" [!$WINDOWS] // Ammo Font | Primary font
		...
		"G_FontDamage"
		{
			"1"
			{
				"name"			"Days" [$WINDOWS] // Damage font | Primary font
				"name"			"Days" [!$WINDOWS] // Damage font | Primary font
				"tall"			"20" // Damage size
				"weight"		"0"
				"additive"		"0"
		...
		"G_FontCritDamage"
		{
			"1"
			{
				"name"			"Days" [$WINDOWS] // Crit damage font | Primary font
				"name"			"Days" [!$WINDOWS] // Crit damage font | Primary font
		...
		"G_FontTargetIDHealth"
		{
			"1"
			{
				"name"			"Days" [$WINDOWS] // Target ID health font | Primary font
				"name"			"Days" [!$WINDOWS] // Target ID health font | Primary font
